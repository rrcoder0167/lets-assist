                ...
                <TableCell>
                  <Badge 
                    ...
                    className={
                      ...
                      report.status === 'in_progress' ? 'bg-blue-500/10 text-blue-500' :
            ...
            <div className="grid gap-4 py-4">
              ...
              <div>
                ...
                <Badge 
                  variant="secondary" 
                  className={
                    selectedReport.status === 'pending' ? 'bg-yellow-500/10 text-yellow-500' :
                    selectedReport.status === 'in_progress' ? 'bg-blue-500/10 text-blue-500' :
                    'bg-green-500/10 text-green-500'
                  }
                >
              ...
              <div>
                ...
                <p className="text-sm whitespace-pre-wrap">{selectedReport.issue}</p>
              </div>
            </div>
          </DialogContent>
        )}
