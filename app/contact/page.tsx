    ...
    return (
        ...
        >
            <div className="text-center mb-8 md:mb-12">
                <h1 className="text-3xl md:text-4xl font-bold tracking-tight mb-3 md:mb-4">Get in Touch</h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                ...
                <Card className="relative group hover:shadow-lg transition-shadow">
                    <CardHeader className="space-y-2 md:space-y-3">
                        ...
                        <CardTitle className="text-lg md:text-xl">Have a cool feature idea?</CardTitle>
                ...
                <Card className="relative group hover:shadow-lg transition-shadow">
                    <CardHeader className="space-y-2 md:space-y-3">
                        ...
                        <CardDescription className="text-sm md:text-base">
                            UI glitches or app not working? Let us know and we&apos;ll fix it ASAP
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
