...
export default function Home() {
  return (
    <>
    <TracingBeam className="xl:ml-20 xl:mr-40 md:ml-20 sm:ml-0">
      ...
      <div>
        ...
        <CardContainer>
          <CardBody className="rounded-xl border bg-secondary p-3">
            <CardItem translateZ={50} className="text-xl font-bold pb-1">Find Volunteering Opportunities</CardItem>
            <CardItem as="p" translateZ={60} className="text-xs pb-1">Finding volunteering opportunities has never been easier than using Let&apos;s Assist&apos;s easy-to-use dashboard! Use tags and location matching to sort through opportunities and retrieve the ones that fit you.</CardItem>
        ...
        <CardContainer>
          <CardBody className="rounded-xl border bg-secondary p-3">
            ...
            <CardItem as="p" translateZ={60} className="text-xs pb-1">The event manager page allows you update your event information and post updates about these events. You can update project information, download participant sheets, and post updates for participants to see.</CardItem>
            <CardItem translateZ={100}>
